...
const ThemeSettings = () =>{
    ...
    return(
        <div className={"bg-half-transparent w-screen fixed nav-item top-0 right-0"}>
            <div className={"float-right h-screen dark:text-gray-200 bg-white dark:bg-[#484B52] w-400 rounded-tl-[15px] rounded-bl-[15px]"}>
                ...
                <div className={"flex-col border-t-1 border-color p-4 ml-4 mr-4"}>
                    ...
                    <div className={"mt-4"}>
                        ...
                        value={"Light"} className={"cursor-pointer"}
                        onChange={setMode}
                    ...
                    <div className={"mt-4"}>
                        <input type={"radio"} id={"dark"} name={"theme"}
                               value={"Dark"} className={"cursor-pointer"}
                               onChange={setMode}
